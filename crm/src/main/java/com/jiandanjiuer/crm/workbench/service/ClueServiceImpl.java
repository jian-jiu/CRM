...
import com.jiandanjiuer.crm.workbench.mapper.ClueMapper;
...
public class ClueServiceImpl implements ClueService {
     ...
     */
    @Override
    public long findCountPagingForDetailClue(Clue clue, Integer beginNo, Integer pageSize) {
        return clueMapper.selectCountPagingForDetailClue(clue, beginNo, pageSize);
    }
